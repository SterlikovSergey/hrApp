    ...
    <a href="#close" title="Закрыть" class="close">X</a>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="dob" name="dateStart" placeholder="10/01/2021">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="dob" name="dateEnd" placeholder="10/01/2021">
                              </div>
                            </div>
